                ...
                @foreach ($school->blogs as $index => $blog)
                    <tr class="bg-white dark:bg-gray-800">
                        <td scope="row" class="px-6 py-4 font-normal text-gray-900 whitespace-nowrap dark:text-white">
                            {{$index + 1}}. 
                            <span class="ml-2 font-normal text-gray-900 whitespace-nowrap dark:text-white uppercase underline text-xl">{{ $blog->blog_title }}</span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="uppercase underline">
                                <div class="text-lg font-medium">
                                    {{ Carbon\Carbon::parse($blog->created_at)->toFormattedDayDateString() }}
                                </div>
