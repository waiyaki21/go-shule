        ...
        this.modalInfo = [
            {
                ...
                backdrop    : 'bg-white dark:bg-gray-700 fixed inset-0 z-110',
                closeClass  : 'w-6 h-6 text-gray-600',
                modalClass  : 'relative bg-white rounded-lg shadow-md dark:bg-gray-700 border-2 border-cyan-600 h-full',
                textClassess: 'mb-2 text-lg font-normal bold-caps text-gray-700 dark:text-gray-400 flex justify-center',
                iconClassess: 'm-2 text-gray-700 w-5 h-5 dark:text-gray-700',
                btnClassess : 'absolute top-3 right-2.5 text-gray-400 bg-transparent hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white',
        ...
        this.modalInfo = [
            {
                ...
                backdrop    : 'bg-white dark:bg-gray-700 fixed inset-0 z-110',
                closeClass  : 'w-6 h-6 text-orange-600',
                modalClass  : 'relative bg-white rounded-lg shadow-md dark:bg-gray-700 border-2 border-orange-600 h-full',
                textClassess: 'mb-2 text-lg font-normal bold-caps text-orange-700 dark:text-orange-700 flex justify-center',
                iconClassess: 'm-2 text-orange-700 w-5 h-5 dark:text-orange-700',
                btnClassess : 'absolute top-3 right-2.5 text-orange-700 bg-transparent hover:text-orange-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white',
        ...
        this.modalInfo = [
            {
                ...
                backdrop    : 'bg-white dark:bg-gray-700 fixed inset-0 z-110',
                closeClass  : 'w-6 h-6 text-red-600',
                modalClass  : 'relative bg-white rounded-lg shadow-md dark:bg-gray-700 border-2 border-red-600 h-full',
                textClassess: 'mb-2 text-lg font-normal bold-caps text-red-700 dark:text-red-400 flex justify-center',
                iconClassess: 'm-2 text-red-700 w-5 h-5 dark:text-red-700',
                btnClassess : 'absolute top-3 right-2.5 text-red-700 bg-transparent hover:text-red-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white',
        ...
        this.modalInfo = [
            {
                ...
                backdrop    : 'bg-white dark:bg-gray-700 fixed inset-0 z-110',
                closeClass  : 'w-6 h-6 text-green-600',
                modalClass  : 'relative bg-white rounded-lg shadow-md dark:bg-gray-700 border-2 border-green-600 h-full',
                textClassess: 'mb-2 text-lg font-normal bold-caps text-green-700 dark:text-green-400 flex justify-center',
                iconClassess: 'm-2 text-green-700 w-5 h-5 dark:text-green-700',
                btnClassess : 'absolute top-3 right-2.5 text-green-400 bg-transparent hover:text-green-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white',
                submitInfo  : 'SUCCESS!',
